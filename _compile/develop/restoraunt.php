...
<html lang="ru">
  ...
  <body>
      ...
      <div class="wrap"><a href="http://saryarka.com/" class="logo"></a>
        ...
        <nav class="close">
          <div class="wrap_menu">
            ...
            <ul id="rest_nav" class="filters open">
    ...
    <section class="shops">
      ...
      <header><b>Кафе бары рестораны</b> <span></span></header>
      <section class="shops_cont">
        ...
        <div class="shop_wrap">
          ...
          <div data-filter="<?php echo types_render_field( 'category_cafe', array('raw' => true) ) ?>" data-id="<?php the_ID(); ?>" class="shop">
    ...
    <script>window.cafe = true</script>
