...
<html lang="ru">
  ...
  <body>
      ...
      <div class="wrap"><a href="http://saryarka.com/" class="logo"></a>
        ...
        <nav class="close">
          <div class="wrap_menu">
            ...
            <ul id="service_nav" class="filters open">
    ...
    <section class="shops">
      ...
      <header><b>Услуги и развлечения</b> <span></span></header>
      <section class="shops_cont">
        ...
        <div class="shop_wrap">
          ...
          <div data-filter="<?php echo types_render_field( 'category_entertainment', array('raw' => true) ) ?>" data-id="<?php the_ID(); ?>" class="shop">
    ...
    <script>window.service = true</script>
