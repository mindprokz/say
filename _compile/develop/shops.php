...
<html lang="ru">
  ...
  <body>
    ...
    <section class="shops">
      ...
      <header><b>Магазины</b> <span></span></header>
      <section class="shops_cont">
        <div class="spinner close">
        ...
        <div class="shop_wrap">
          ...
          ?>
          <div data-filter="<?php echo $filter_category; ?>" data-id="<?php the_ID(); ?>" class="shop">
            <div class="title_wrap">
              <div class="title"><?php echo the_title(); ?></div>
            </div>
            <div class="padding">
              <div class="wrap">
                <div style="background: url('<?php echo $logo; ?>') no-repeat center center; background-size: contain;" class="logo"></div>
              </div>
            </div>
          </div>  <?php endwhile;
           endif; ?>
        ...
        <div class="content">
          ...
          <div class="images">
            ...
            <div class="slider">
              <div class="flexslider">
                <ul class="slides">
                  <li>
                    <div style="background: url('images/test_logo.jpg') no-repeat center center; background-size: 80%;" class="image"></div>
                  </li>
                  <li>
                    <div style="background: url('images/test_logo.jpg') no-repeat center center; background-size: 80%;" class="image"></div>
                  </li>
          ...
          <div class="text">
            ...
            <div class="contacts_shop">
              <div class="number">
                <div class="icon"></div><span>+7 (7172) 345-43-53</span>
              </div><a href="http://mindpro.kz" target="_blank" class="site">
                <div class="icon"></div><span>salesmarket.kz</span></a>
              <div class="location">
                <div class="icon"></div><span>ТЦ «Сарыарка» 3 этаж Бутик 345</span>
              </div>
            </div>
    ...
    <script>window.shops = true</script>
