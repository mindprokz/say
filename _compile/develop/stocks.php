    ...
    <section class="stocks_page">
      ...
      <section class="shops_cont">
        ...
        <article data-id="<?php the_ID(); ?>" class="stock_elem">
          <div class="wrap">
            <h3><?php the_title(); ?></h3>
            <h4><?php echo types_render_field( 'stock_subheader', array('raw' => true) ); ?></h4>
            <div style="background: url(<?php echo types_render_field( 'stock_picture', array('raw' => true) ); ?>) no-repeat center center; background-size: contain;" class="img"></div>
